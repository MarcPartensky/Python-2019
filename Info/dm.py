...
liste1=[]
for i in range(50):
    liste1.append(randint(0,10))


liste2=[randint(0,10) for i in range(50)]

#7b
def Compter1(liste,valeur):
    compteur=0
...
Compter2=lambda liste,valeur:sum([element==valeur for element in liste])

#8b
def Positionner(liste,valeur):
    positions=[]
...
Positionner2=lambda liste,valeur:[n for n,element in enumerate(liste) if element==valeur]
...
#print(Converter(Positionner)())


a=[1,2,3,5,1,3,5,4,4,2]
print(puissancede2(4))
